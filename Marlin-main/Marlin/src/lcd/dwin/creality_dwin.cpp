  ...
  switch (menu) {
    ...
    case Info:
      ...
      case Leveling:
        ...
        #define LEVELING_SLOT (LEVELING_SETTINGS + ANY(AUTO_BED_LEVELING_UBL, AUTO_BED_LEVELING_BILINEAR))
        #define LEVELING_LOAD (LEVELING_SLOT + ANY(AUTO_BED_LEVELING_UBL, AUTO_BED_LEVELING_BILINEAR))
        #define LEVELING_SAVE (LEVELING_LOAD + ANY(AUTO_BED_LEVELING_UBL, AUTO_BED_LEVELING_BILINEAR))
